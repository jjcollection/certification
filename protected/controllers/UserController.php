...
class UserController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model = new User;
        $modelMhs = new ProfilMahasiswa;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);
       
        if (isset($_POST['User'], $_POST['ProfilMahasiswa'])) {
            $model->attributes = $_POST['User'];
            $modelMhs->attributes = $_POST['ProfilMahasiswa'];
            $dua = $model->password;
            ...
            $model->save();
            if ($model->save()) {
                $modelMhs->nim= $model->username;
                $modelMhs->kodeProdi = $modelMhs->kodeProdi;
