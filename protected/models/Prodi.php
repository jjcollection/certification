...
class Prodi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kodeProdi', 'required'),
			array('kodeProdi', 'length', 'max'=>50),
			array('namaProdi', 'length', 'max'=>100),
			/*
			//Example username
			...
			array('kodeProdi, namaProdi', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'profilMahasiswas' => array(self::HAS_MANY, 'ProfilMahasiswa', 'kodeProdi'),
		);
	}
