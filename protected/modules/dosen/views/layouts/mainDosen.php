...
<html lang="en-US">
    ...
    <body>
            ...
            <aside id="aside">
                <nav id="sideNav"><!-- MAIN MENU -->
                    <ul class="nav nav-list">
                        ...
                        <li>
                            <a href="index.php?r=dosen/profilDosen/view&id=<?= Yii::app()->user->name?>">
                                <i class="main-icon fa fa-user"></i>
                                <span class="label label-danger pull-right"> <?= Yii::app()->user->name ?></span> <span>Profil</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-menu-arrow pull-right"></i>
                                <i class="main-icon fa fa-user-md"></i> <span>Pertemuan</span>
                            </a>
                            <ul><!-- submenus -->
                                <li><a href="index.php?r=dosen/pertemuan/create">Tambah Pertemuan</a></li>
                                <li><a href="index.php?r=dosen/pertemuan/admin">Kelola Pertemuan</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-menu-arrow pull-right"></i>
                                <i class="main-icon fa fa-pencil-square-o"></i> <span>Penilaian</span>
                            </a>
                            <ul><!-- submenus -->
                                <li><a href="index.php?r=dosen/nilaiMaster/admin">Data Nilai</a></li>
                            </ul>
                        </li>
                    </ul>
                    <!-- SECOND MAIN LIST -->
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong>SERTIFIKASI</strong> <!-- panel title -->
                                <small class="size-12 weight-300 text-mutted hidden-xs">STT INDONESIA TANJUNGPINANG <?=date('Y')?></small>
                            </span>
                            <!-- right options -->
        ...
        <script type="text/javascript">
             ...
             */
            _toastr("Selamat Datang, <?= Yii::app()->user->name ?>", "top-right", "success", false);
