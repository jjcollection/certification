...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
       ...
       // 'idPendaftaran0.idUser0.username',
        array(
            'name' => 'idPendaftaran0.idUser0.username',
            'header' => 'NIM',
            'headerHtmlOptions' => array('width' => '10%', 'style' => 'text-align:center'),
            'value' => '$data->idPendaftaran0->idUser0->username',
            'htmlOptions' => array('width' => '', 'style' => 'text-align:center'),
        ),
        array(
            'name' => 'nama',
        ...
        array(
            ...
            'buttons' => array
                ...
                'input' => array
                    ...
                    'htmlOptions' => array('width' => '', 'style' => 'text-align:center'),
                    'url' => 'Yii::app()->createUrl("dosen/nilaiMaster/update", array("id"=>$data->idNilaiMaster))',
                ),
            ),
        ),
    ),
