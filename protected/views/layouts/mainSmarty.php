                                ...
                                <ul id="topMain" class="nav nav-pills nav-main">
                                    ...
                                    <li class="dropdown mega-menu"><!-- PORTFOLIO -->
                                        ...
                                        if (Yii::app()->user->getLevel() == 2) {
                                            echo "<li class=\"dropdown\">";
                                            echo CHtml::link('DOSEN', array('/dosen'));
                                            echo "</li>";
                                        }
                                        ?> 
                                    </li>
                                    <li class="dropdown mega-menu"><!-- PORTFOLIO -->
                                        ...
                                        if (Yii::app()->user->getLevel() == 3) {
                                            echo "<li class=\"dropdown\">";
                                            echo CHtml::link('MAHASISWA', array('/mahasiswa'));
                                            echo "</li>";
                                        }
                                        ?> 
                                    </li>
            ...
            <div class="slider fullwidthbanner-container roundedcorners">
                ...
                <div class="fullwidthbanner" data-height="600" data-shadow="0" data-navigationStyle="preview2">
                    <ul class="hide">
                        ...
                        <!-- SLIDE  -->
                        <li data-transition="parallaxtobottom" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off"  data-title="Tingkatkan Skill Anda">
                            <!-- MAIN IMAGE -->
                            ...
                            <div class="tp-caption content_text_center skewfromleft tp-resizeme"
                                ...
                                Ikuti sertifikasi bagi mahasiswa STT Indonesia Tanjungpinang.
                            </div>
                        ...
                        <!-- SLIDE  -->
                        <li data-transition="parallaxtotop" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" data-title="Pendidikan dan Pelatihan">
                            <!-- MAIN IMAGE -->
                            ...
                            <div class="tp-caption font-roboto skewfromleft tp-resizeme"
                                ...
                                <small>Pendidikan dan Pelatihan</small><br />
                                <small>Berbagai Keahlian terkini.</small>
                            </div>
                            ...
                            <div class="tp-caption skewfromrightshort tp-resizeme"
                                ...
                                Program keahlian Autocad, web, Visual Basic .Net, gimp dll..<br />
                            ...
                            <div class="tp-caption sfb tp-resizeme"
                                ...
                                <a class="btn btn-3d btn-teal btn-lg" href="index.php?r=user/create">Registrasi</a>
                            </div>
                            ...
                            <div class="tp-caption sfb tp-resizeme"
                                ...
                                <a class="btn btn-3d btn-blue btn-lg" href="index.php?r=site/login">LOGIN</a>
                            </div>
                        </li>
